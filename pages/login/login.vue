<template>
	<view class="login">
		<view class="content">
			...
			<!-- 主体表单 -->
			<view class="main">
				<wInput v-model="phoneData" type="text" maxlength="11" placeholder="邮箱/电话" :value='phoneData'></wInput>
				<wInput v-model="passData" type="password" maxlength="11" placeholder="密码" :value='passData'></wInput>
			</view>
	...
	export default {
		data() {
			return {
				...
				phoneData: '18832053301', //用户/电话
				passData: 'sjq19971129', //密码
